...
<div id="header">
    ...
    <nav role="navigation">
        ...
        <div class="small-logo">
            <span class="text-primary">Service Pulse Portal</span>
        </div>
                    ...
                    <div class="panel-body" id="mainscorebox">
                        <div class="row">
                            <div class="col-lg-4 col-md-12 text-center">                            	
								...
								<div class="row m-t-sm m-l-xs m-r-xxxs" id="overeallscore_box"></div>
								<div class="row">
			                        <div class="stats-title text-center m-l-md m-t-md">
                            ...
                            <div class="col-lg-8 col-md-12 text-center">
                                ...
                                <div class="flot-chart m-l-xxs" id="overallscorechart_box"  style="height: 210px">
            ...
            <div class="col-lg-3 col-md-12">
                <div class="hpanel stats">
                    ...
                    <div class="panel-body h-200">
                        ...
                        <div class="row" style="margin: 0 2px 95px 2px">
	                        <div class="flot-chart" id="prodfamilychart_box"></div>
                        </div>
                        <div class="m-t-xl">
                            <div class="row m-t-xxl .p-b-n-lg " id="prodfam_box"></div>
                        </div>
                    </div>
        	...
        	<div class="col-lg-6 col-md-12">
       		 	<div class="row">
		                ...
		                <div class="hpanel stats" id="scorebreakdownscore">		                
		                    <div class="panel-body piechart_box" style="min-height:250px">
		                        <div class="stats-title pull-left">
            ...
            <div class="col-lg-3 col-md-12">
                <div class="hpanel" id="functionscore">
                    <div class="panel-body list">
                    	<div class="row">
	                    	<div class="text-center m-b-lg m-r-xs m-l-xs">
            ...
            <div class="col-lg-3 col-md-12">
                <div class="hpanel stats">
                    ...
                    <div class="panel-body h-200">
                        ...
                        <div class="m-t-xl">
                           <div class="row m-t-xxl .p-b-n-lg" id="languagectr_box">
            ...
            <div class="col-lg-3 col-md-12">
                <div class="hpanel stats">
                    <div class="panel-body h-200">
                        ...
                        <div class="row" style="margin: 0 2px 95px 2px">
	                        <div class="flot-chart">
	                            <div class="flot-chart-content" id="specialistchart_box"></div>
	                        </div>
                        </div>
                        <div class="m-t-xs">

                            <div class="row m-t-xxl .p-b-n-lg" id="specialist_box"></div>
                        </div>
                    </div>
                    <div class="panel-footer">
				                    ...
				                    <div class="panel-body">
				                        <div class="row">
				                            <div class="col-lg-3 col-md-12 text-center">                            	
												...
												<div class="row m-t-sm m-l-xs" id="prodlcscore_box_modalprodlc"></div>
												<div class="row">
							                        <div class="stats-title text-center m-l-md">
				                            ...
				                            <div class="col-lg-9 col-md-12">
				                                ...
				                                <div class="flot-chart" id="prodlcscorechart_box_modalprodlc"  style="height: 80px">
				        ...
				        <div class="row">
				       		 	...
				       		 	<div class="row">
						                ...
						                <div class="hpanel stats">		                
						                    <div class="panel-body piechart_box">
						                        ...
						                        <div class="clearfix"></div>
						                        <div class="flot-chart">
						                            <div class="flot-chart-content" id="satsurveybreakdown_box_modalprodlc"><canvas id="satsurveybreakdown_modalprodlc" height="138px" width="345px" style="width: 345px; height: 138px;"></canvas></div>
						                        </div>
						                        <div class="m-t-xs">
						                        </div>
						                    </div>
						                    <div class="panel-footer contact-footer" id="detractsupport_tab_modalprodlc"><div class="row"><div class="col-lg-3 col-md-12 border-right"> <div class="contact-stat"><span>Supporters: </span> <strong>73%</strong></div> </div><div class="col-lg-3 col-md-12 border-right"> <div class="contact-stat"><span>Positive: </span> <strong>23%</strong></div> </div><div class="col-lg-3 col-md-12 border-right"> <div class="contact-stat"><span>Negative: </span> <strong>4%</strong></div> </div><div class="col-lg-3 col-md-12"> <div class="contact-stat"><span>Detractors: </span> <strong>1%</strong></div> </div></div></div>
						                </div>
						            </div>
						            <div class="col-lg-6 col-md-12">
						                <div class="hpanel stats">		                
						                    <div class="panel-body piechart_box">
						                        ...
						                        <div class="clearfix"></div>
						                        <div class="flot-chart">
						                            <div class="flot-chart-content" id="factorbuckets_box_modalprodlc"><canvas id="factorbuckets_modalprodlc" height="138px" style="width: 345px; height: 138px;"></canvas></div>
						                        </div>
						                        <div class="m-t-xs">
						
						                        </div>
						                    </div>
						                    <div class="panel-footer contact-footer" id="factorbuckets_tab_modalprodlc"><div class="row"><div class="col-lg-3 col-md-12 border-right"> <div class="contact-stat"><span>Knowledge: </span> <strong>75%</strong></div> </div><div class="col-lg-3 col-md-12 border-right"> <div class="contact-stat"><span>Speed: </span> <strong>76%</strong></div> </div><div class="col-lg-3 col-md-12 border-right"> <div class="contact-stat"><span>Ownership: </span> <strong>78%</strong></div> </div><div class="col-lg-3 col-md-12"> <div class="contact-stat"><span>Comms: </span> <strong>81%</strong></div> </div></div></div>
						                </div>
						            </div>
				       		 	</div>
				       		 	<div class="row">
				            ...
				            <div class="col-md-12 col-lg-4">
				                <div class="hpanel">
				                    ...
				                    <div class="panel-body list">
				                        <div id="prodlc_listtitle">
					                 <div class="pull-left">
			                          	<h4>Workgroup</h4>
			                        <small class="fo m-t-md">Service Pulse Score by Workgroups</small>
			                        </div>
			                        <div class="stats-icon pull-right">
				                    ...
				                    <div class="panel-body">
				                        <div class="row">
				                            <div class="col-md-12 col-lg-3 text-center">                            	
												...
												<div class="row m-t-sm m-l-xs" id="prodlcscore_box_modalwg"></div>   
												<div class="row">
							                        <div class="stats-title text-center m-l-md">
				       		 	...
				       		 	<div class="row">
						                ...
						                <div class="hpanel stats">		                
						                    <div class="panel-body piechart_box">
						                        ...
						                        <div class="clearfix"></div>
						                        <div class="flot-chart">
						                            <div class="flot-chart-content" id="satsurveybreakdown_box_modalwg"><canvas id="satsurveybreakdown_modalwg" height="138px" width="345px" style="width: 345px; height: 138px;"></canvas></div>
						                        </div>
						                        <div class="m-t-xs">
						                        </div>
						                    </div>
						            ...
						            <div class="col-md-12 col-lg-6">
						                <div class="hpanel stats">		                
						                    <div class="panel-body piechart_box">
						                        ...
						                        <div class="clearfix"></div>
						                        <div class="flot-chart">
						                            <div class="flot-chart-content" id="factorbuckets_box_modalwg"><canvas id="factorbuckets_modalwg" height="138px" width="345px" style="width: 345px; height: 138px;"></canvas></div>
						                        </div>
						                        <div class="m-t-xs">
				            ...
				            <div class="col-md-12 col-lg-4">
				                <div class="hpanel">
				                    ...
				                    <div class="panel-body list">
					                 ...
					                 <div class="pull-left">
			                          	<h4>Agents</h4>
				                        <small class="fo m-t-md">Service Pulse Score Agents</small>

			                        </div>
			                        <div class="stats-icon pull-right">
			                            <i class="pe-7s-call fa-4x"></i>
			                        </div>
			                        <div class="clearfix"></div>
			                        </div>
           ...
           <div class="modal-dialog modal-lg superlargemodal">
               <div class="modal-content">
                   ...
                   <div class="modal-body spprawdatabody">
                   		<div id="rawdatabody"> 
                   			<table id="rawdatatab" class="table table-striped hover cell-border row-border" style="{cellspacing:0; width:2500px;}"></table>
                   		</div>							
                   </div>
               </div>
           </div>
                   ...
                   <div class="modal-content">
                       <div class="modal-body">
	                       <div class="panel-image">
					            <img class="img-responsive" src="images/banner.jpg" height="500px" width="840px" >
					        </div>
