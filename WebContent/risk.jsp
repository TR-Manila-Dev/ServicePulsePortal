                        ...
                        <div class="row">
                            <div class="col-md-12 col-lg-4 text-center">                            	
		                        <div class="row">
									...
									<div class="row m-t-sm m-l-xs m-r-xxxs" id="content_overeallscore_box"></div>
									<div class="row">
		                            ...
		                            <div class="col-md-12 col-lg-8 text-center">
		                                ...
		                                <div class="flot-chart m-l-xxs m-t-md" id="content_overallscorechart_box"  style="height: 200px">
				...
				<div class="col-md-12 col-lg-4 ">
	    				<div class="hpanel stats">
	        				<div class="panel-body h-200">
		                        ...
		                        <div class="m-t-xs">
		                            <div class="row m-t-xxl .p-b-n-lg " id="overeallscore_box"></div>
		                        </div>
		                       	</div>   
		...
		<div class="col-md-12 col-lg-3">
		    	<div class="hpanel" id="functionscore">
		        	<div class="panel-body list">
						<div class="row">
							<div class="m-l" id="prodlc_listtitle">
							 <div class="pull-left">
											                          	<h3>Workgroup</h3>
						                    							<small class="fo m-t-md">Service Pulse Score by Workgroup</small>
											                        </div>
											                        <div class="stats-icon pull-right m-r-sm">
						...
						<div class="list-group" id="prodlc_list">
						</div>
					</div>
				                ...
				                <div class="hpanel">
				                    ...
				                    <div class="panel-body list">
				                        <div id="prodlc_listtitle">
				                         <div class="pull-left">
											                          	<h3>Agents</h3>
											                          	<small class="fo m-t-sm">Service Pulse Score Agents</small>
											                        </div>
											                        <div class="stats-icon pull-right">
