	    				...
	    				<div class="hpanel stats">
	        				<div class="panel-body h-200">
		                        ...
		                        <div class="flot-chart">
		                        	<div class="flot-chart-content" id="cmoverallscorechart_box_modalwg">                     	</div>
	                      		</div>
		                        <div class="m-t-xs">
		                            <div class="row m-t-xxxl .p-b-n-lg " id="cmoverallscore_box_modalwg"></div>
		                        </div>
		                       	</div>   
				...
				<div class="row">
					<div class="hpanel stats" >
	                    <div class="panel-body h-200">
	                        ...
	                        <div class="m-t-xs">
	                           <div class="row m-t-xxxl .p-b-n-lg" id="teamscore_box_modalwg">   
	                            </div>
	                        </div>
	    			</div>
                    <div class="panel-footer">
				...
				<div class="hpanel stats">
                    <div class="panel-body h-200">
                        ...
                        <div class="m-t-xs">
                            ...
                            <div class="row m-t-xxxl .p-b-n-lg" id="workgroupscore_box_modalwg"></div>
                        </div>
                    </div>
                    <div class="panel-footer">
