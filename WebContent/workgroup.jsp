		...
		<div class="row">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-lg-4 text-center">                            	
		                        <div class="row">
									...
									<div class="row m-t-sm m-l-xs m-r-xxxs" id="prodlcscore_box_modalwg"></div>
									<div class="row">
					                       <div class="stats-title text-center m-l-md m-t-md">
		                            ...
		                            <div class="col-sm-12 col-lg-8 text-center">
		                                ...
		                                <div class="flot-chart m-l-xxs" id="prodlcscorechart_box_modalwg"  style="height: 200px">
				...
				<div class="col-sm-12 col-lg-4 ">
	    				<div class="hpanel stats">
	        				<div class="panel-body h-200">
		                        ...
		                        <div class="m-t-xs">
		                            <div class="row m-t-xxxl .p-b-n-lg " id="overeallscore_box"></div>
		                        </div>
		                       	</div>   
	    		...
	    		<div class="col-sm-12 col-lg-4 ">
	    			<div class="hpanel stats" id="factorbucketsscore">		                
				    	<div class="panel-body piechart_box">
				            ...
				            <div class="flot-chart">
				            	<div class="flot-chart-content" id="factorbuckets_box_wg">
				                </div>
				            </div>
				            <div class="m-t-xs">
							</div>
						</div>
				        <div class="panel-footer contact-footer" id="factorbuckets_tab_wg">
					    </div>
				</div>
			</div>
			</div>
	    	...
	    	<div class="row">
				...
				<div class="hpanel" id="timelinessbucketscore">
					...
					<div class="panel-footer">
						Shows the total number of cases per timeliness bucket captured in Service Pulse and its percentage 						                
					</div>
				</div>
				</div>
			</div>
		    	...
		    	<div class="row">
			    	<div class="hpanel" id="functionscore">
			        	<div class="panel-body list">
							<div class="row">
								<div class="m-l" id="prodlc_listtitle" style="text-transform:capitalize">
<div class="pull-left">
											                          	<h4>Agent List</h4>
							<small class="fo m-b-md">Service Pulse Score by Functions</small>
											                        </div>
											                        <div class="stats-icon pull-right">
											                            <i class="pe-7s-call fa-4x m-r-md"></i>
											                        </div>
											                        <div class="clearfix"></div>
								</div>
							...
							<div class="list-group" id="agent_list">
							</div>
						</div>
				...
				<div class="row">
					<div class="hpanel stats" >
	                    <div class="panel-body h-200">
	                        <div class="stats-title pull-left">
	                            <h3><span id ='rightbox_fxngroup' style='text-transform:capitalize'></span></h3>
	                        </div>
	                        <div class="stats-icon pull-right">
	                        ...
	                        <div class="m-t-xs">
	                           <div class="row m-t-xxxl .p-b-n-lg" id="prodlcgroup_box">   
	                            </div>
	                        </div>
	    			</div>
                    <div class="panel-footer">
				...
				<div class="hpanel stats">
                    <div class="panel-body h-200">
                        ...
                        <div class="m-t-xs">
                            ...
                            <div class="row m-t-xxxl .p-b-n-lg" id="prodlcscore_box"></div>
                        </div>
                    </div>
                    <div class="panel-footer">
						            ...
						            <div class="col-sm-12 col-lg-6">
						                <div class="hpanel stats">		                
						                    <div class="panel-body piechart_box">
						                        ...
						                        <div class="clearfix"></div>
						                        <div class="flot-chart">
						                            <div class="flot-chart-content" id="factorbuckets_box_modalprodlc"><canvas id="factorbuckets_modalprodlc" height="138" width="345" style="width: 345px; height: 138px;"></canvas></div>
						                        </div>
						                        <div class="m-t-xs">
				       		 	...
				       		 	<div class="row">
						                ...
						                <div class="hpanel stats">		                
						                    <div class="panel-body piechart_box">
						                        ...
						                        <div class="clearfix"></div>
						                        <div class="flot-chart">
						                            <div class="flot-chart-content" id="satsurveybreakdown_box_modalwg"><canvas id="satsurveybreakdown_modalwg" height="138" width="345" style="width: 345px; height: 138px;"></canvas></div>
						                        </div>
						                        <div class="m-t-xs">
						                        </div>
						                    </div>
						            ...
						            <div class="col-sm-12 col-lg-6">
						                <div class="hpanel stats">		                
						                    <div class="panel-body piechart_box">
						                        ...
						                        <div class="clearfix"></div>
						                        <div class="flot-chart">
						                            <div class="flot-chart-content" id="factorbuckets_box_modalwg"><canvas id="factorbuckets_modalwg" height="138" width="345" style="width: 345px; height: 138px;"></canvas></div>
						                        </div>
						                        <div class="m-t-xs">
				                        ...
				                        <div class="row">
				                            ...
				                            <div class="col-sm-12 col-lg-8 pull-right m-r-md">				                                
				                                <div class="row">
					                                ...
					                                <div class="flot-chart" id="cmoverallscorechart_box_modalwg"  style="height: 180px">
