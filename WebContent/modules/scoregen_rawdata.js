...
function GetOverallSppScore(param_view, param_freqno, param_yearno) {
	...
	function RenderChartJsData (){
		...
		var lineData = {
		    ...
		    var dataTable = "<canvas id='overallscorechart' height='100'></canvas>";		    
...
function GetProdLcGroupSppScore(param_view, param_freqno, param_yearno, param_prodlclist, assignscorebox) {
	...
	function RenderChartJsData (){
		...
		var lineData = {
		    ...
		    var dataTable = "<canvas id='"+ appendtochart.substring(0,appendtochart.indexOf("_")) +"' height='140'></canvas>";		    
	...
	function RenderSppScore() {
		...
		dataTable = dataTable + "<div class='row m-l-xs'><div class='col-md-4 m-l-sm'><h1 class='no-margins font-bold " + ScorePassFail((tp2allscore * 100).toFixed(0)) + " '>" + (tp2allscore * 100).toFixed(0) + "%</h1></div>";
		dataTable = dataTable + "<div class='col-md-9 m-t-xs m-l-md text-center'><h4 >"+ (pre_tp2allscore * 100).toFixed(0) + "% <i class='fa "+ ArrowUpDown((tp2allscore * 100).toFixed(0),(pre_tp2allscore * 100).toFixed(0), 1)+ " "+ ScorePassFail((tp2allscore * 100).toFixed(0),(pre_tp2allscore * 100).toFixed(0), 2) + "'></i></h4></div>";
		dataTable = dataTable + "</div></div>"
		dataTable = dataTable + "<div class='col-lg-6 text-center m-t-xs'>";
		dataTable = dataTable + "<div class='row'><small class='stat-label font-bold'>Top 4 Box</small></div>";
		dataTable = dataTable + "<div class='row m-l-xs'><div class='col-md-4 m-l-sm'><h1 class='no-margins font-bold "+ ScorePassFail((tp4allscore * 100).toFixed(0)) + " '>"+ (tp4allscore * 100).toFixed(0) + "%</h1></div>";
		dataTable = dataTable + "<div class='col-md-9 m-t-xs m-l-md text-center'><h4 >" + (pre_tp4allscore * 100).toFixed(0) + "% <i class='fa " + ArrowUpDown((tp4allscore * 100).toFixed(0),(pre_tp4allscore * 100).toFixed(0), 1) + " " + ArrowUpDown((tp4allscore * 100).toFixed(0), (pre_tp4allscore * 100).toFixed(0), 2) + "'></i></h4></div>";
		dataTable = dataTable + "</div></div>"
	...
	function RenderDetractSupport(){
		...
		$("#detractsupport_tab").append(dataTable);
		 ...
		 var doughnutData = [
		                 ...
		                 dataTable2 = dataTable2 + "<canvas id='satsurveybreakdown' height='150'></canvas>" 
		...
		var barOptions = {
			 ...
			 var barChartData = {
			         ...
			         datasets: [
		                 ...
		                 dataTable2 = dataTable2 + "<canvas id='factorbuckets' height='130'></canvas>" 
...
function GetProdLcSppScore(param_view, param_freqno, param_yearno, param_prodlc) {
	...
	function RenderChartJsData (){
		...
		var lineData = {
		    ...
		    var dataTable = "<canvas id='prodlcscorechart_modalprodlc' height='60'></canvas>";		    
		...
		var barOptions = {
			 ...
			 var barChartData = {
			         ...
			         datasets: [
		                 ...
		                 dataTable2 = dataTable2 + "<canvas id='factorbuckets_modalprodlc' height='130'></canvas>" 
...
function GetAgSppScore_list(param_view, param_freqno, param_yearno, param_workgroup) {
	...
	function RenderSppScore() {
		...
		for (var i = 0; i < rownum; i++) {
			...
			taTable = dataTable + "<div class='list-item' onclick='RunScoreWg(\""+ case_owner[i] +"\")'>"
			dataTable = dataTable + "<div class='row'>"
			dataTable = dataTable + "<div class='col-xs-5 fnxlist_margin_ovrd'>"
