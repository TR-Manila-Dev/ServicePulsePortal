...
function TourMe(){
	...
	var tour = new Tour({
		steps : [ {
			...
			title : "Overall Score",
			content : "Contains previous and current score for Top 2 Box and 4. Also shows score trend chart. ",
			backdrop: true
		}, {
...
function GetOverallSppScore(param_view, param_freqno, param_yearno) {
	...
	function RenderChartJsData (){
		...
		var lineData = {
		    ...
		    var dataTable = "<center><canvas id='overallscorechart' height='120'></canvas></center>";		    
	...
	function RenderSppScore() {
		...
		dataTable = dataTable + "<div class='row'><small class='stat-label font-bold'>Top 2 Box</small></div>";
		dataTable = dataTable + "<div class='row m-l-xs'><div class='col-lg-4 m-l-sm'><h1 class='no-margins font-bold " + ScorePassFail((tp2allscore * 100).toFixed(0)) + " '>" + (tp2allscore * 100).toFixed(0) + "%</h1></div>";
		dataTable = dataTable + "<div class='col-lg-9 m-t-xs m-l-md text-center'><h4 >"+ (pre_tp2allscore * 100).toFixed(0) + "% <i class='fa "+ ArrowUpDown((tp2allscore * 100).toFixed(0),(pre_tp2allscore * 100).toFixed(0), 1)+ " "+ ScorePassFail((tp2allscore * 100).toFixed(0),(pre_tp2allscore * 100).toFixed(0), 2) + "'></i></h4></div>";
		dataTable = dataTable + "</div></div>"
		dataTable = dataTable + "<div class='col-lg-6 text-center m-t-xs'>";
		dataTable = dataTable + "<div class='row'><small class='stat-label font-bold'>Top 4 Box</small></div>";
		dataTable = dataTable + "<div class='row m-l-xs'><div class='col-lg-4 m-l-sm'><h1 class='no-margins font-bold "+ ScorePassFail((tp4allscore * 100).toFixed(0)) + " '>"+ (tp4allscore * 100).toFixed(0) + "%</h1></div>";
		dataTable = dataTable + "<div class='col-lg-9 m-t-xs m-l-md text-center'><h4 >" + (pre_tp4allscore * 100).toFixed(0) + "% <i class='fa " + ArrowUpDown((tp4allscore * 100).toFixed(0),(pre_tp4allscore * 100).toFixed(0), 1) + " " + ArrowUpDown((tp4allscore * 100).toFixed(0), (pre_tp4allscore * 100).toFixed(0), 2) + "'></i></h4></div>";
		dataTable = dataTable + "</div></div>"
...
function GetProdLcSppScore(param_view, param_freqno, param_yearno, param_prodlc) {
	...
	function RenderChartJsData (){
		...
		var lineData = {
		    ...
		    var dataTable = "<canvas id='prodlcscorechart_modalprodlc' height='100'></canvas>";		    
	...
	function RenderProdLcSppScore() {
		...
		dataTable = dataTable + "<h1 class=' font-bold "+ ScorePassFail((tp2allscore * 100).toFixed(0))+ " overall_score' style='margin-top-0px;'>" + (tp2allscore * 100).toFixed(0) + "%</h1>";
	...
	function RenderDetractSupport(){
		...
		$("#detractsupport_tab").append(dataTable);
		 ...
		 var doughnutData = [
		                 ...
		                 dataTable2 = dataTable2 + "<center><canvas id='satsurveybreakdown_modalprodlc' height='150'></canvas></center>" 
		...
		var barOptions = {
			 ...
			 var barChartData = {
			         ...
			         datasets: [
		                 ...
		                 dataTable2 = dataTable2 + "<center><canvas id='factorbuckets_modalprodlc' height='180'></canvas></center>" 
...
function GetWgScore_TimeBucket(param_view, param_freqno, param_yearno, param_prodlc) {
	...
	function RenderSppScoreTimeBucket() {
		...
		dataTable = dataTable + "<th style='width: 200px;'>Team</th>"
		dataTable = dataTable + "<th style='width: 50px;'>< 30 mins</th>"
		dataTable = dataTable + "<th style='width: 50px;'>0.5 - 1 hrs</th>"
		...
		dataTable = dataTable + "<th style='width: 50px;'>> 24 hrs</th>"
...
function GetWgSppScore_list(param_view, param_freqno, param_yearno, param_prodlc) {
	...
	function RenderSppScore() {
		...
		for (var i = 0; i < rownum; i++) {
			...
			dataTable = dataTable + "<div class='row'>"
			dataTable = dataTable + "<div class='col-xs-4 fnxlist_margin_ovrd'>"
			dataTable = dataTable + "<a href='#'><h4 class='no-margins font-bold text-color3' style='font-size: 1em; color:gray;'>"+ case_owner_role[i] + "</h4></a>"
			dataTable = dataTable + "</div>"
			dataTable = dataTable + "<div class='col-xs-4 text-center m-l-m'>"
			dataTable = dataTable + "<small class='stat-label'>Top 2 Box</small>" 
			dataTable = dataTable + "<h3 class='m-b-xxs " + ScorePassFail((tp2allscore[i] * 100).toFixed(0)) + "'>" + (tp2allscore[i] * 100).toFixed(0) + "%</h3>"
			dataTable = dataTable + "</div>"
			dataTable = dataTable + "<div class='col-xs-4 text-center'>" 
			dataTable = dataTable + "<small class='stat-label'>Top 4 Box</small>"
			dataTable = dataTable + "<h3 class='m-b-xxs " + ScorePassFail((tp4allscore[i] * 100).toFixed(0)) + "'>" + (tp4allscore[i] * 100).toFixed(0) + "%</h3>"
			dataTable = dataTable + "</div>"
			dataTable = dataTable + "</div>"
			dataTable = dataTable + "<div class='row'>"
			dataTable = dataTable + "<div class='col-xs-4'>"
...
function GetWgSppScore(param_view, param_freqno, param_yearno, param_workgroup) {
	...
	function RenderChartJsData (){
		...
		var lineData = {
		    ...
		    var dataTable = "<canvas id='prodlcscorechart_modalwg' height='60'></canvas>";		    
	...
	function RenderWgSppScore() {
		...
		dataTable = dataTable + "<small class='stat-label'>Previous</small>";
		dataTable = dataTable + "</div>"
		dataTable = dataTable + "<div class='col-lg-5 pull-right'>";
		dataTable = dataTable + "<small class='stat-label text-center'>Top 4 Box</small>";
		dataTable = dataTable + "<h1 class='font-bold " + ScorePassFail((tp4allscore * 100).toFixed(0)) + " overall_score'>" + (tp4allscore * 100).toFixed(0) + "%</h1>";
		dataTable = dataTable + "<h4 class='m-t-xs'>" + (pre_tp4allscore * 100).toFixed(0) + "% <i class='fa " + ArrowUpDown((tp4allscore * 100).toFixed(0), (pre_tp4allscore * 100).toFixed(0), 1)+ " "+ ArrowUpDown((tp4allscore * 100).toFixed(0), (pre_tp4allscore * 100).toFixed(0), 2) + "'></i></h4>";
		dataTable = dataTable + " <small class='stat-label'>Previous</small>";
		dataTable = dataTable + " </div>";
...
function GetDetractSupportWgSppScore(param_view, param_freqno, param_yearno, param_workgroup){
	...
	function RenderDetractSupport(){
		...
		dataTable = dataTable +"<div class='row'>"
		dataTable = dataTable +"<div class='col-lg-3 border-right'> <div class='contact-stat'><span>Supporters: </span> <strong>"+ Math.round(tp2_supporter) +"%</strong></div> </div>"
		dataTable = dataTable +"<div class='col-lg-3 border-right'> <div class='contact-stat'><span>Positive: </span> <strong>"+ Math.round(tp2_posambivalent) +"%</strong></div> </div>"
		dataTable = dataTable +"<div class='col-lg-3 border-right'> <div class='contact-stat'><span>Negative: </span> <strong>"+ Math.round(tp2_negambivalent) +"%</strong></div> </div>"
		dataTable = dataTable +"<div class='col-lg-3 '> <div class='contact-stat'><span>Detractors: </span> <strong>"+ Math.round(tp2_detractor) +"%</strong></div> </div>"
		dataTable = dataTable +"</div>"
		...
		var barOptions = {
			 ...
			 var barChartData = {
			         ...
			         datasets: [
		                 ...
		                 dataTable2 = dataTable2 + "<canvas id='factorbuckets_modalwg' height='130'></canvas>" 
...
function GetAgScore_TimeBucket(param_view, param_freqno, param_yearno, param_workgroup) {
	...
	function RenderSppScoreTimeBucket() {
		...
		dataTable = dataTable + "<thead><tr>"
		dataTable = dataTable + "<th>Agents</th>"
...
function GetAgSppScore_list(param_view, param_freqno, param_yearno, param_workgroup) {
	...
	function RenderSppScore() {
		...
		for (var i = 0; i < rownum; i++) {
			...
			dataTable = dataTable + "<div class='list-item '>"
			dataTable = dataTable + "<div class='row'>"
			dataTable = dataTable + "<div class='col-xs-4 fnxlist_margin_ovrd'>"
			dataTable = dataTable + "<h4 class='no-margins font-bold text-color3' style='font-size: 1em;'>"+ case_owner[i] + "</h4>"
			dataTable = dataTable + "</div>"
			dataTable = dataTable + "<div class='col-xs-4 text-center m-l-m'>"
			dataTable = dataTable + "<small class='stat-label'>Top 2 Box</small>" 
			dataTable = dataTable + "<h3 class='m-b-xxs " + ScorePassFail((tp2allscore[i] * 100).toFixed(0)) + "'>" + (tp2allscore[i] * 100).toFixed(0) + "%</h3>"
			dataTable = dataTable + "</div>"
			dataTable = dataTable + "<div class='col-xs-4 text-center text-center'>" 
			dataTable = dataTable + "<small class='stat-label'>Top 4 Box</small>"
			dataTable = dataTable + "<h3 class='m-b-xxs " + ScorePassFail((tp4allscore[i] * 100).toFixed(0)) + "'>" + (tp4allscore[i] * 100).toFixed(0) + "%</h3>"
			dataTable = dataTable + "</div>"
			dataTable = dataTable + "</div>"
