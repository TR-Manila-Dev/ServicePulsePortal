				...
				function TourMe(){
					...
					var tour = new Tour({
						steps : [ {
							...
							content : "Contains previous and current score for Top 2 Box and 4 per Agent",
							backdrop: true
						}, {
							element : "#userprofile",
							title : "Profile Panel",
...
function ChangeFunctionName(fxn) {
	...
	}else if(fxn === "Other Products/Sunset"){
...
function GetWgSppScore(param_view, param_freqno, param_yearno, param_workgroup, param_tmwg) {
	...
	function RenderChartJsData (){
		...
		var lineData = {
		    ...
		    var dataTable = "<canvas id='prodlcscorechart_modalwg' height='100'></canvas>";		    
	...
	function RenderDetractSupport(){
		...
		$("#detractsupport_tab_wg").append(dataTable);
		 ...
		 var doughnutData = [
		                 ...
		                 dataTable2 = dataTable2 + "<center><canvas id='satsurveybreakdown_wg' height='150px'></canvas></center>" 
...
function GetFactorBucketsWgSppScore(param_view, param_freqno, param_yearno, param_workgroup, param_tmwg){
	...
	function RenderFactorBuckets(){
		...
		$("#factorbuckets_box_wg").html("");
		$("#factorbuckets_tab_wg").html(""); 
		...
		$("#factorbuckets_tab_wg").append(dataTable);
		...
		var barOptions = {
			 ...
			 var barChartData = {
			         ...
			         datasets: [
		                 ...
		                 dataTable2 = dataTable2 + "<center><canvas id='factorbuckets_wg' height='180'></canvas></center>" 
		                 $("#factorbuckets_box_wg").append(dataTable2);
...
function GetAgScore_TimeBucket(param_view, param_freqno, param_yearno, param_workgroup, param_tmwg) {
	...
	function RenderSppScoreTimeBucket() {
		...
		dataTable = dataTable + "<th style='width: 200px;'>Agents</th>"
...
function GetOverallSppScore(param_view, param_freqno, param_yearno) {
	...
	function RenderChartJsData (){
		...
		var lineData = {
		    ...
		    var dataTable = "<center><canvas id='overallscorechart' height='140'></canvas></center>";		    
...
function GetProdLcGroupSppScore(param_view, param_freqno, param_yearno, param_prodlclist) {
	...
	function RenderChartJsData (){
		...
		var lineData = {
		    ...
		    var dataTable = "<center><canvas id='prodlcgroupchart' height='120'></canvas>";		    
...
function GetProdLcSppScore(param_view, param_freqno, param_yearno, param_prodlc) {
	...
	function RenderChartJsData (){
		...
		var lineData = {
		    ...
		    var dataTable = "<center><canvas id='prodlcscorechart' height='120'></canvas></center>";		    
...
function GetCmWgScore_TimeBucket(param_view, param_prodfam, param_freqno, param_yearno) {
	...
	function RenderSppScoreTimeBucket() {
		...
		dataTable = dataTable + "<thead><tr>"
		dataTable = dataTable + "<th style='width: 150px;'>Functions</th>"
		dataTable = dataTable + "<th style='width: 5px;'><30 mins</th>"
		dataTable = dataTable + "<th style='width: 5px;'>0.5-1 hrs</th>"
		dataTable = dataTable + "<th style='width: 5px;'>1-2 hrs</th>"
		dataTable = dataTable + "<th style='width: 5px;'>2-4 hrs</th>"
		dataTable = dataTable + "<th style='width: 5px;'>4-8 hrs</th>"
		dataTable = dataTable + "<th style='width: 5px;'>8-24 hrs</th>"
		dataTable = dataTable + "<th style='width: 5px;'>> 24 hrs</th>"
		dataTable = dataTable + "</tr></thead>"
		dataTable = dataTable + "<tbody>"
