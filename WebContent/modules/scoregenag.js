	...
	function RenderDetractSupport(){
		...
		$("#detractsupport_tab_wg").append(dataTable);
		 ...
		 var doughnutData = [
		                 ...
		                 dataTable2 = dataTable2 + "<center><canvas id='satsurveybreakdown_wg' height='150'></canvas></center>" 
...
function GetAgScore_TimeBucket(param_view, param_freqno, param_yearno, param_empid) {
	...
	function RenderSppScoreTimeBucket() {
		...
		dataTable = dataTable + "<th style='width: 150px'>Types</th>"
		dataTable = dataTable + "<th style='width: 5px;text-align:center;'><30 mins</th>"
		dataTable = dataTable + "<th style='width: 5px;text-align:center;'>0.5-1 hrs</th>"
		dataTable = dataTable + "<th style='width: 5px;text-align:center;'>1-2 hrs</th>"
		dataTable = dataTable + "<th style='width: 5px;text-align:center;'>2-4 hrs</th>"
		dataTable = dataTable + "<th style='width: 5px;text-align:center;'>4-8 hrs</th>"
		dataTable = dataTable + "<th style='width: 5px;text-align:center;'>8-24 hrs</th>"
		dataTable = dataTable + "<th style='width: 5px;text-align:center;'>> 24 hrs</th>"
...
function GetAgSppScore_list(param_view, param_freqno, param_yearno, param_empid) {
	...
	function RenderSppScore() {
		...
		for (var i = 0; i < rownum; i++) {
			...
			dataTable = dataTable + "<a href='#'><h4 class='no-margins font-bold text-color3' style='font-size: 1em;'>"+ issue_type[i] + "</h4></a>"
			dataTable = dataTable + "</div>"
...
function GetTmSppScore(param_view, param_freqno, param_yearno, param_workgroup) {
	...
	function RenderChartJsData (){
		...
		var lineData = {
		    ...
		    var dataTable = "<center><canvas id='teamscorechart_modalwg' height='140'></canvas></center>";		    
...
function GetWgSppScore(param_view, param_freqno, param_yearno, param_workgroup) {
	...
	function RenderChartJsData (){
		...
		var lineData = {
		    ...
		    var dataTable = "<center><canvas id='workgroupscorechart_modalwg' height='140'></canvas></center>";		    
...
function GetSppCmWgScore(param_view, param_prodfam, param_freqno, param_yearno) {
	...
	function RenderChartJsData (){
		...
		var lineData = {
		    ...
		    var dataTable = "<center><canvas id='cmoverallscorechart_modalwg' height='140px'></canvas></center>";		    
