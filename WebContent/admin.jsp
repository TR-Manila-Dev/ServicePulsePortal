				        	...
				        	<div class="col-lg-8 col-sm-12">
				       		 	<div class="row">
						                ...
						                <div class="hpanel stats">		                
						                    ...
						                    <div class="panel-footer contact-footer" id="detractsupport_tab_modalprodlc"><div class="row"><div class="col-lg-3 col-sm-12 border-right"> <div class="contact-stat"><span>Supporters: </span> <strong>73%</strong></div> </div><div class="col-lg-3 col-sm-12 border-right"> <div class="contact-stat"><span>Positive: </span> <strong>23%</strong></div> </div><div class="col-lg-3 col-sm-12 border-right"> <div class="contact-stat"><span>Negative: </span> <strong>4%</strong></div> </div><div class="col-lg-3 col-sm-12"> <div class="contact-stat"><span>Detractors: </span> <strong>1%</strong></div> </div></div></div>
						                </div>
						            </div>
						            <div class="col-lg-6 col-sm-12">
						                <div class="hpanel stats">		                
						                    ...
						                    <div class="panel-footer contact-footer" id="factorbuckets_tab_modalprodlc"><div class="row"><div class="col-lg-3 col-sm-12 border-right"> <div class="contact-stat"><span>Knowledge: </span> <strong>75%</strong></div> </div><div class="col-lg-3 col-sm-12 border-right"> <div class="contact-stat"><span>Speed: </span> <strong>76%</strong></div> </div><div class="col-lg-3 col-sm-12 border-right"> <div class="contact-stat"><span>Ownership: </span> <strong>78%</strong></div> </div><div class="col-lg-3 col-sm-12"> <div class="contact-stat"><span>Comms: </span> <strong>81%</strong></div> </div></div></div>
						                </div>
						            </div>
				       		 	</div>
				       		 	<div class="row">
